package com.tsinsi.auth.infrastructure.configuration;
...
@EnableJpaRepositories(
        basePackages = "com.tsinsi.*.adapter.out.persistence.repository",
...
public class SourceDatabaseConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean sourceEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.tsinsi.*.adapter.out.persistence.entity")
